...
pushd grammar
# java -cp $TOOL org.antlr.v4.Tool AssemblyLexer.g4 -o ../src/parser -Dlanguage=TypeScript
# java -cp $TOOL org.antlr.v4.Tool AssemblyParser.g4 -o ../src/parser -Dlanguage=TypeScript
