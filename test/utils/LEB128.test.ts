...
Deno.test("properly encodes uint 0",  () => {
    const bytes: number[] = [];
...
Deno.test("properly encodes uint 1",  () => {
    const bytes: number[] = [];
...
Deno.test("properly encodes uint 2",  () => {
    const bytes: number[] = [];
...
Deno.test("properly encodes uint 7F",  () => {
    const bytes: number[] = [];
...
Deno.test("properly encodes uint 624485",  () => {
    const bytes: number[] = [];
...
Deno.test("properly encodes int -123456",  () => {
    const bytes: number[] = [];
